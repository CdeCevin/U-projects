...
main:- write("Bienvenido, ingrese un número:"),nl,read(Numero),crear(L1),split(Numero,Numero,_,L1),raiz(Numero),primo(Numero,2),par(Numero),nl.
...
raiz(Num) :- Int is rationalize(sqrt(Num)),not(integer(Int)),write("Es raiz exacta"),!.
